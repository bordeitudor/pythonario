...
class RedKoopaShell(Drawable):
    ...
    def __init__(self, tilemap: Tilemap):
        ...
        self.delete_flag = 0
        self.alive = True
        self.sprite = Sprite(engine.instance.surface_manager.get_surface("atlas_enemies"), self.body.position, Vector2(32, 28), FRect(69, 34, 16, 14))
        pass