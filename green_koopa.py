...
class GreenKoopa(Drawable):
    ...
    def __init__(self, tilemap: Tilemap):
        ...
        self.sprite = Sprite(engine.instance.surface_manager.get_surface("atlas_enemies"), self.body.position, Vector2(32,48), FRect(1, 1, 16, 24))
        self.walk_animation = Animation([FRect(1, 1, 16, 24), FRect(18, 1, 16, 24), FRect(1, 1, 16, 24)], 6)
        self.delete_flag = 0
        self.alive = True
        pass